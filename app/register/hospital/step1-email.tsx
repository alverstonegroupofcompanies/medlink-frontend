...
import { ArrowLeft, Mail, Building2 } from 'lucide-react-native';
import { LinearGradient } from 'expo-linear-gradient';
import API from '../../api';
import { HospitalPrimaryColors as PrimaryColors } from '@/constants/hospital-theme';
import { ErrorModal } from '@/components/ErrorModal';

export default function HospitalEmailScreen() {
  ...
  const handleSendOtp = async () => {
    ...
    setLoading(true);
    try {
      const response = await API.post('/hospital/registration/send-otp', {
        email: email.trim(),
      });
      ...
      if (response.data.status) {
        ...
        router.push({
          pathname: '/register/hospital/step2-otp',
            ...
            <View style={styles.card}>
              ...
              <View style={styles.headerIconContainer}>
                ...
                <View style={styles.headerTitleContainer}>
                  ...
                  <Text style={styles.headerTagline}>Hospital Registration</Text>
                </View>
              </View>
